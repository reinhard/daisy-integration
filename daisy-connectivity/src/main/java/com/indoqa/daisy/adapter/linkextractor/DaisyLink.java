...
public class DaisyLink {
    ...
    public DaisyLink(final long docId, final String name, final String branchId, final String languageId, final String path,
            final DaisyDocument parent) {
    ...
    public boolean equals(Object o) {
        ...
        return new EqualsBuilder().append(this.docId, comp.docId).append(this.branchId, comp.branchId)
                .append(this.languageId, comp.languageId).isEquals();
    }
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(this.docId).append(this.branchId).append(this.languageId).toHashCode();
    }

    @Override
    public String toString() {
        return "DaisyLink[id=" + this.getDocId() + " branchId=" + this.getBranchId() + " languageId=" + this.getLanguageId()
