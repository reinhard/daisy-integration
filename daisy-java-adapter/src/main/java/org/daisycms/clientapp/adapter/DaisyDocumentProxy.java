...
import org.daisycms.clientapp.adapter.pr.PublisherRequestDocumentBuilder;
...
public class DaisyDocumentProxy implements DaisyDocument {
    ...
    public DaisyDocumentProxy(final long docId, final DaisyRepositoryAccessFacade docAccessFacade) {
    ...
    public DaisyDocumentProxy(final long docId, final DaisyRepositoryAccessFacade docAccessFacade,
            final PRDocumentConfiguration prConfig, final String branchId,
    ...
    public byte[] asByteArray() {    
        ...
        try {
            ...
            throw new DaisyClientException(
                    "A problem occurred while serializing the document returned from the publisher.", e);
        }
    ...
    public void toSax(ContentHandler contentHandler) {
        this.repoAccessFacade.getPublisherDocument(
            PublisherRequestDocumentBuilder.createPublisherRequestDocument(this, this.prConfig), 
            contentHandler);
    }
